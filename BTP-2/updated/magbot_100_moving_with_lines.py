...
This version fixes the issue where Magbots mostly rotate in place.
...
Run:
    python magbot_100_moving_with_lines.py
"""
...
class Params:
    ...
    video_path: str = "magbot_100_moving_with_lines.mp4"
    gif_path: str = "magbot_100_moving_with_lines.gif"
...
title = ax.set_title("100 Moving Magbots | rotation + interaction lines")
...
def update(frame):
    ...
    title.set_text(
        f"100 Moving Magbots | frame={frame} | light={P.light_mode} | "
