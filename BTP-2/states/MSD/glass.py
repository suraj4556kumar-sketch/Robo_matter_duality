"""
120-Magbot MSD Only Code
------------------------

No animation.
No simulation display.

This code runs the dynamics for 1600 steps and directly plots:
...
# ============================================================
# Run simulation silently for MSD only
# ============================================================
...
def run_simulation_for_msd():
    ...
    print("Running 120-Magbot simulation for MSD only...")
...
def plot_msd(time_lag, msd):
    ...
    plt.xlabel("Lag time")
    plt.ylabel("MSD")
    plt.title("Time-Origin Averaged MSD of 120 Magbots")
